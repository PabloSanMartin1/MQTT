    ...
    //++++++++++++++++++++++++++++++++++++++++++++
        final MqttAndroidClient mqttAndroidClient = new MqttAndroidClient(this.getApplicationContext(), "tcp://209.126.106.184:1883", "SensorSantos", persistence);
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                System.out.println("El mensaje ha llegado a destino: " + topic + ": " + new String(message.getPayload()));
            }
            ...
            mqttAndroidClient.connect(mqttConnectOptions, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    try {
                        ...
                        mqttAndroidClient.subscribe("Santos/android", 0);
                        System.out.println("Suscrito a  Santos/android");
                        System.out.println("Publicando mensaje...");
                        mqttAndroidClient.publish("Santos/android", new MqttMessage("Pablo Andrès San Martìn Merino".getBytes()));
                ...
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    ...
                    System.out.println("Entregada: " + exception.toString());
                }
            });
        } catch (MqttException ex) {
